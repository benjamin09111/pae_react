...
const Navbar = () => {
    ...
    <nav className='app__navbar'>
        ...
        <div className='app__navbar-smallscreen'>
            ...
            <div className='app__navbar-smallscreen_overlay'>
                ...
                <ul className='app__navbar-smallscreen-links'>
                    <Link className='app_navbar-link-responsive' to="/">Home</Link>
                    <Link className='app_navbar-link-responsive' to="/pay">Pay</Link>
                    <a href="#whatispae">¿Qué es PAE?</a>
                    <a href="#pros">Profesionales</a>
                <a href="#comments">Comentarios</a>
                </ul>
        ...
        <div className='app__navbar-buttons-container'>
            <a className='app__navbar-buttons-container-link' target="_blank" href="https://www.mimanualdelbebe.com">Mi Manual del Bebé</a>
        </div>
    </nav>
    )
}
